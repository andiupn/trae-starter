# पांडुआन स्क्रीनशॉट ट्राई स्टार्टर
...
सिलाकन सिम्पन स्क्रीनशॉट वेबसाइट ट्राई स्टार्टर डि फोल्डर आईएनआई!

## दफ़्तर फ़ाइल यांग डिबुटुहकन
- `homepage.png`: स्क्रीनशॉट टैम्पिलन यूटामा होमपेज
- (वैकल्पिक) `mobile-view.png`: टैम्पिलन डि पेरांगकट मोबाइल
- (वैकल्पिक) `demo-feature.png`: डेमो फ़ितुर इंटरैक्टिफ़

## स्क्रीनशॉट के लिए वेब नमूना देखें
वेब नमूना के लिए गुनाकन डॉकर:
