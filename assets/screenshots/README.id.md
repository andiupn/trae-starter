# Panduan Tangkapan Layar TRAE Starter
...
- `homepage.png`: Tangkapan layar tampilan beranda utama
- (opsional) `mobile-view.png`: Tampilan di perangkat seluler
- (opsional) `demo-feature.png`: Demo fitur interaktif

## Cara Garis Web Sample untuk Screenshot
Gunakan Docker untuk menjalankan sampel web:
