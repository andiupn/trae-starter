...
Eenvoudig screenshot website TRAE Starter di folder ini!

## Daftar File yang Dibutuhkan
- `homepage.png`: Screenshot tampilan utama-startpagina
- (optioneel) `mobile-view.png`: Tampilan di perangkat mobile
- (optioneel) `demo-feature.png`: Demo fitur interaktif

## Cara Menjalankan Webvoorbeeld voor screenshot
Gunakan Docker voor een ander webvoorbeeld:
