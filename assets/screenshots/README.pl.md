# Panduan Zrzut ekranu TRAE Starter
...
Silakan prosta strona zrzutów ekranu TRAE Starter di folder ini!

## Plik Daftar i Dibutuhkan
- `homepage.png`: Zrzut ekranu strony głównej Tampilan Utama
- (opcjonalnie) `mobile-view.png`: Tampilan di perangkat mobile
- (opcjonalnie) `demo-feature.png`: Demo fitur interaktif

## Próbka internetowa Cara Menjalankan i zrzut ekranu
Gunakan Docker dla przykładowej strony internetowej:
