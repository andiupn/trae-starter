...
- `homepage.png`: Captură de ecran a paginii de pornire a tampilan utama
- (opțional) `mobile-view.png`: Tampilan di perangkat mobile
- (opțional) `demo-feature.png`: Demo fitur interaktif

## Cara Menjalankan Web Sample pentru captură de ecran
Gunakan Docker este un eșantion de web:
