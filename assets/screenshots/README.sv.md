# Panduan Skärmdump TRAE Starter
...
Silakan simpan skärmdump webbplats TRAE Starter i mappen ini!

## Daftar File yang Dibutuhkan
- `homepage.png`: Skärmdump tampilan utamas hemsida
- (valfritt) `mobile-view.png`: Tampilan di perangkat mobil
- (valfritt) `demo-feature.png`: Demo fitur interaktif

## Cara Menjalankan Web Sample till skärmdump
Gunakan Docker till menjalankan webbexempel:
